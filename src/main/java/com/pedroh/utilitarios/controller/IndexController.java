...
import com.pedroh.utilitarios.util.FormataDataUtil;
...
public class IndexController {
    ...
    public ResponseEntity<String> cadastrarRegistro(
    	...
    	Registro registro = new Registro(valor, descricao, FormataDataUtil.formataData(data), tipo);
    ...
    @RequestMapping("/deletarRegistro/{id}")
    public String deletarRegistro(@PathVariable("id") Long id){
    	try {
